...
// Tells the animation to loop special time,But the loopAnimation should be NO, If you want animation play only time, you should also set repeatTime to 1.0;
// when you add a new json, the repeatTime will reset to 1.0 .
...
/**
* description which module use lottie display animation,report to rdm.
*@param SDPType NSString
* in Simulator debug,if SDPType nil ,will push alertView,release , device not.
* 注册：字符串长度尽量短些不超过32
* 1)设置测试页面动画字符串        0
* 2)QQVipPokeWindowAnimator   1
* 3)QQLightInteractionMPAView 2
* 4)UserSummaryViewController 3
* 5)NearbyListEntranceCell    4
* 6)NearbyShortVideo          5
* 7)SharedDocment             6
<<<<<<< .working
* 8)GLiveNobility             7
||||||| .merge-left.r376120
=======
* 8)GLiveNobility             7
* 9)QQVipPokeAnimationView    8
>>>>>>> .merge-right.r376413
*/
@property(nonatomic,strong,nonnull)NSString* SDPType;
