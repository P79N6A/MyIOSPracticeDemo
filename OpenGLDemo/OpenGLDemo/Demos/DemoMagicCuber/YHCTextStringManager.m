...
GLint string_attributes[NUM_ATTRIBUTES];
...
GLint string_unifroms[NUM_UNIFORMS];
...
- (YHCTextStringManager *)initWithCharacterSheetName : (NSString *)newCharacterSheetName
{
    if (self = [super init]) {
        ...
        string_attributes[ATTRIBUTE_VERTEX] = [_program getAttributeIDForIndex:@"ATTRIBUTE_VERTEX"];
        string_attributes[ATTRIBUTE_TEXTURE_COORD] = [_program getAttributeIDForIndex:@"ATTRIBUTE_TEXTURE_COORD"];
        
        string_unifroms[UNIFORM_TEXTURE] = [_program getUniformIDForIndex:@"UNIFORM_TEXTURE"];
        string_unifroms[UNIFORM_COLOR] = [_program getUniformIDForIndex:@"UNIFORM_COLOR"];
        string_unifroms[UNIFORM_ALPHA] = [_program getUniformIDForIndex:@"UNIFORM_ALPHA"];
...
- (void)drawTextString:(YHCTextString *)textString
{
    ...
    glUniform1i(string_unifroms[UNIFORM_TEXTURE], 0);
    glUniform3fv(string_unifroms[UNIFORM_COLOR], 1, [textString getOpenGLColors]);
    glUniform1f(string_unifroms[UNIFORM_ALPHA], [textString getOpenGLAlpha]);
    
    glVertexAttribPointer(string_attributes[ATTRIBUTE_VERTEX], 3, GL_FLOAT, 0, 0, [textString getOpenGLVertexArray]);
    glEnableVertexAttribArray(string_attributes[ATTRIBUTE_VERTEX]);
    
    glVertexAttribPointer(string_attributes[ATTRIBUTE_TEXTURE_COORD], 2, GL_FLOAT, 0, 0, [textString getOpenGLTextureCoordArray]);
    glEnableVertexAttribArray(string_attributes[ATTRIBUTE_TEXTURE_COORD]);
