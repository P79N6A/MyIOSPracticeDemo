...
#define FC     0.33,1.00, 0.33,0.67, 0.67,1.00, 0.67,0.67  //1 Front face 黄
#define RC     0.67,0.67, 0.33,0.67, 0.67,0.33, 0.33,0.33  //2 Right face 绿
#define BC     0.33,0.33, 0.33,0.00, 0.67,0.33, 0.67,0.00  //3 Back face  灰
#define LC     0.33,1.00, 0.00,1.00, 0.33,0.67, 0.00,0.67  //4 Left face  蓝
#define DC     0.33,0.67, 0.00,0.67, 0.33,0.33, 0.00,0.33  //5  down face 棕
#define TC     0.00,0.33, 0.00,0.00, 0.33,0.33, 0.33,0.00  //6  Top face  红
...
static const GLfloat textureCoords[][52]={
    FC,RC,BC,LC,DC,MV,TC,   FC,NC,NC,NC,NC,MV,TC,   FC,RC,NC,NC,NC,MV,TC,   FC,NC,NC,LC,NC,MV,NC,
    FC,NC,NC,NC,NC,MV,NC,   FC,RC,NC,NC,NC,MV,NC,   FC,NC,NC,LC,DC,MV,NC,   FC,NC,NC,NC,DC,MV,NC,
    FC,RC,NC,NC,DC,MV,NC,   NC,NC,NC,LC,NC,MV,TC,   NC,NC,NC,NC,NC,MV,TC,   NC,RC,NC,NC,NC,MV,TC,
    NC,NC,NC,LC,NC,MV,NC,   NC,NC,NC,NC,NC,MV,NC,   NC,RC,NC,NC,NC,MV,NC,   NC,NC,NC,LC,DC,MV,NC,
    NC,NC,NC,NC,DC,MV,NC,   NC,RC,NC,NC,DC,MV,NC,   NC,NC,BC,LC,NC,MV,TC,   NC,NC,BC,NC,NC,MV,TC,
...
+ (void)clearColor: (Cube *)cubes:(int)cubeCount
{
    int flag=0;
...
GLint select_attributes[NUM_SELECT_ATTRIBUTES];
// Uniform index.
enum {
...
GLint select_uniforms[NUM_SELECT_UNIFORMS];
...
+ (void)switchPrograme:(YHCOpenGLProgram *)program
{
    ...
    select_attributes[ATTRIBUTE_SELECT_VERTEX] = [program getAttributeIDForIndex:@"ATTRIBUTE_SELECT_VERTEX"];
    select_attributes[ATTRIBUTE_SELECT_COLOR] = [program getAttributeIDForIndex:@"ATTRIBUTE_SELECT_COLOR"];
    
    select_uniforms[UNIFORM_SELECT_MVP_MATRIX] = [program getUniformIDForIndex:@"UNIFORM_SELECT_MVP_MATRIX"];
}
