...
#define __FILE__ "UIView+BTPosition.m"
...
{
    self.frame = CGRectMake(self.CZ_F_OriginX, self.CZ_F_OriginY, w, h);
}

- (void)pSetOriginX:(CGFloat)x Y:(CGFloat)y
{
    self.frame = CGRectMake(x, y, self.CZ_F_SizeW, self.CZ_F_SizeH);
}
