...
/*!
 @discussion    默认开/关麦
 */
typedef NS_ENUM(NSInteger, EnterRoomMic_MODE) {
    
    ENTERROOM_MIC_MODE_CLOSE                     = 0, //OpenSDK默认进房关麦
    ENTERROOM_MIC_MODE_OPEN = 1, //进房默认开麦
};
/*!
 @discussion    屏幕分享接收模式
 */
...
typedef NS_ENUM(NSInteger, avAudioCategory) {
    ...
    CATEGORY_MEDIA_PLAY_AND_RECORD_HIGH_QUALITY = 3,
};
/*!
 @discussion    音频设备状态
 */
