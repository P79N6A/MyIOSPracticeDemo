...
extern "C" {
    ...
    void ksTranslateMatrixLoad(ksMatrix4 * result, float tx, float ty, float tz);
    void ksScaleMatrixLoad(ksMatrix4 * result, float sx, float sy, float sz);
//    void ksScaleMatrixLoad(ksMatrix4 * result, float tx, float ty, float tz);
