...
static NSString *const g_nv12FragmentShaderString1 = IJK_SHADER_STRING
(
    ...
    void main()
    {
        ...
        if(texture2D(SamplerY, bottomtexcoord).r < 0.01)
...
{
    return g_nv12FragmentShaderString1;
}
...
- (void) render: (void *) overlay
{
   ...
   // } else {
        _preferredConversion = kColorConversionQQ;
  //  }
