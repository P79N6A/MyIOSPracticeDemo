...
typedef NS_ENUM(NSInteger, FalcoXMLDictionaryAttributesMode)
{
    FalcoXMLDictionaryAttributesModePrefixed = 0, //default
    FalcoXMLDictionaryAttributesModeDictionary,
    FalcoXMLDictionaryAttributesModeUnprefixed,
    FalcoXMLDictionaryAttributesModeDiscard
};


typedef NS_ENUM(NSInteger, FalcoXMLDictionaryNodeNameMode)
{
    FalcoXMLDictionaryNodeNameModeRootOnly = 0, //default
    FalcoXMLDictionaryNodeNameModeAlways,
    FalcoXMLDictionaryNodeNameModeNever
};


static NSString *const FalcoXMLDictionaryAttributesKey   = @"__attributes";
static NSString *const FalcoXMLDictionaryCommentsKey     = @"__comments";
static NSString *const FalcoXMLDictionaryTextKey         = @"__text";
static NSString *const FalcoXMLDictionaryNodeNameKey     = @"__name";
static NSString *const FalcoXMLDictionaryAttributePrefix = @"_";


@interface FalcoXMLDictionaryParser : NSObject <NSCopying>
...
@property (nonatomic, assign) FalcoXMLDictionaryAttributesMode attributesMode;
@property (nonatomic, assign) FalcoXMLDictionaryNodeNameMode nodeNameMode;
...
@interface NSDictionary (FalcoXMLDictionary)
...
//@interface NSString (FalcoXMLDictionary)
//
