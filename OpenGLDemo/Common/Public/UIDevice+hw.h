...
typedef NS_ENUM(NSInteger, QQBiologyIDType) {
    QQBiologyIDTypeNone,        // 没有生物学ID
    QQBiologyIDTypeTouchID,     // 支持TouchID
    QQBiologyIDTypeFaceID       // 支持FaceID
};
